...
<tr>
	...
	<?php } ?>
		...
		<tr>
			...
			<td><?=arraySelect( $ipr, 'item_priority', 'size="1" class="text" id="medium"', @$hditem["item_priority"] )?></td>
		</tr>
    ...
    */ ?>
	...
	<td valign="top" width="50%">
		...
		<tr>
			...
			<td><?=arraySelect( $ict, 'item_calltype', 'size="1" class="text" id="medium"', @$hditem["item_calltype"] )?></td>
		</tr>

		<tr>
			<td align="right" nowrap><?=$AppUI->_('Call Source')?>:</td>
			<td><?=arraySelect( $ics, 'item_source', 'size="1" class="text" id="medium"', @$hditem["item_source"] )?></td>
		</tr>

		<tr>
			<td align="right" nowrap><?=$AppUI->_('Operating System')?>:</td>
			<td><?=arraySelect( $ios, 'item_os', 'size="1" class="text" id="medium"', @$hditem["item_os"] )?></td>
		</tr>

		<tr>
			<td align="right"><?=$AppUI->_('Application')?>:</td>
			<td><?=arraySelect( $iap, 'item_application', 'size="1" class="text" id="medium"', @$hditem["item_applic"] )?></td>
		</tr>

		<tr>
			<td align="right"><?=$AppUI->_('Severity')?>:</td>
			<td><?=arraySelect( $isv, 'item_severity', 'size="1" class="text" id="medium"', @$hditem["item_severity"] )?></td>
		</tr>

    <tr>
      <td align="right"><?=$AppUI->_('Project')?>:</td>
      <td><?=arraySelect( $projects, 'item_project_id', 'size="1" class="text" id="large"', @$hditem["item_project_id"] )?></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>
        <input type="checkbox" name="notify" value="1" checked /> <?=$AppUI->_( 'Notify assignee by e-mail' );?>
      </td>
    </tr>
		</table>
	</td>
